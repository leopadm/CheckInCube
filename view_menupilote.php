...
<head>
	<meta charset="utf-8">
	<link rel="icon" type="image/png" href="Ressources/Medias/CerveauAPP.png">
...
<header>
    <nav class="navigation">
        <ul>
            <li class="accueil"><a>Bienvenue <?=$_SESSION['appellation']?> <?=$_SESSION['prenom']?> <?=$_SESSION['nom']?></a></li>
        ...
        <ul>
            ...
            <li class="deroulant"><a href="#">Langues </a>
                <ul class="sous">
                    <li><a href="#">Français<img src="Ressources/Medias/Fra.png" height="40px"  /></a></li>
                    <li><a href="#">English<img src="Ressources/Medias/Ang.png" height="50px"  /></a></li>
                    <li><a href="#">Deutsch<img src="Ressources/Medias/All.png" height="40px" /></a></li>
                    <li><a href="#">Español<img src="Ressources/Medias/Esp.png" height="40px"  /></a></li>
                </ul>
            </li>
        </ul>
    </nav>
    <img class="bgim" src="Ressources/Medias/Image25.jpg" >
</header>
