...
function write($nom, $prenom, $mail, $genre, $appellation, $date){
    $bdd = new PDO('mysql:host=localhost;dbname=checkincube;charset=utf8','root','root');
    $str = "INSERT INTO pilote (nom, prenom, mail, genre, appellation, date_naissance) VALUES (':nom', ':prenom', ':mail', ':genre', ':appellation', ':date');";
    $sql = $bdd->prepare($str);    
