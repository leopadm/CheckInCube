...
function writeCR($nom, $prenom, $mail, $mdp, $genre, $appellation, $date, $nomEntreprise, $poste){
    $bdd = new PDO('mysql:host=localhost;dbname=checkincube;charset=utf8','root','root');
    $str = "INSERT INTO centre_recherche (nom, prenom, mail, mot_de_passe, genre, appellation, date_naissance, nomEntreprise, poste) VALUES (':nom', ':prenom', ':mail', ':mdp', ':genre', ':appellation', ':date', ':nomEntreprise ', ':poste');";
    $sql = $bdd->prepare($str);    
