...
<footer class="footer-distributed">
    <div class="footer-gauche">
        ...
        <p class="liens-footer">
            ...
            |
            <a href="index.php?page=recherche">Apropos</a>
            |
            <a href="inscription.html">Contact us</a>
            |
            <a href="index.php?page=viewCGU">Legal notices</a>
            |
    ...
    <div class="footer-centre">
        <div>
            <img src="/Ressources/Medias/localisateur.svg" class="icons">
            <p>28 rue Notre-Dame des Champs,
            ISEP, PARIS 75006, France</p>
        </div>
        <div>
            <img src="/Ressources/Medias/telephone.svg" class="icons">
            <p>01 49 54 52 00</p>
        </div>
        <div>
