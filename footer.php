...
<footer class="footer-distributed">
    ...
    <div class="footer-centre">
        <div>
            <img src="../localisateur.svg" class="icons">
            <p>28 rue Notre-Dame des Champs,
            ISEP, PARIS 75006, France</p>
        </div>
        <div>
            <img src="../telephone.svg" class="icons">
            <p>01 49 54 52 00</p>
        </div>
        <div>
            <img src="../enveloppe%20(1).svg" class="icons">
    ...
    <div class="footer-droite">
        ...
        <div class="footer-reseaux">
            <a href="https://www.instagram.com/gab.b/"><img src="../icons8-facebook%20(1).svg" class="footer-reseaux"></a>
            <a href="https://www.instagram.com/gab.b/"><img src="../icons8-instagram%20(1).svg" class="footer-reseaux"></a>
            <a href="https://www.instagram.com/gab.b/"><img src="../icons8-linkedin%20(1).svg" class="footer-reseaux"></a>
        </div>
